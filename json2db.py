...
##                try:
                ...
                if ab.getSrcDomain() not in sites.keys():
                    ...
                    sites[ab.getSrcDomain()] = int(rp.inserted_primary_key)
                    total_sites+=1
                ...
                if ab.getSrcUrl() not in urls.keys():
                    ...
                    urls[ab.getSrcUrl()] = int(rp.inserted_primary_key)
                    total_urls+=1
                ...
                #ad_id = rp.lastrowid
                ad_id = int(rp.inserted_primary_key)
                total_ads+=1
                ...
                for k,v in links.items():
                    ...
                    if land_domain not in landdomains.keys():
                        if len(land_domain)>0:
                            ...
                            landdomains[land_domain] = int(rp.inserted_primary_key)
                            total_landdomains+=1
